          ...
          <div className="mx-3 flex flex-row gap-3 pt-2">
            ...
            <div className="flex-1">
              {!isFormValid ? (
                ...
                <FixedBottomButton
                  className="bg-greedy/15 hover:bg-greedy/50 border-greedy/20 text-greedy border-2"
                  onClick={() => navigate(`/meeting/${code}`)}
                >
                  완료
                </FixedBottomButton>
                ...
                <AlertDialog>
                  <AlertDialogTrigger asChild>
                    <FixedBottomButton className="bg-greedy/15 hover:bg-greedy/50 border-greedy/20 text-greedy border-2">
                      완료
                    </FixedBottomButton>
                  </AlertDialogTrigger>
