    ...
    <AlertDialog open={isOpen} onOpenChange={onClose}>
      <AlertDialogContent className="w-[90%] rounded-2xl">
        ...
        <AlertDialogFooter className="mt-4 flex-row gap-2">
          <AlertDialogAction
            onClick={onClose}
            className="bg-greedy! hover:bg-greedy/50! h-11 flex-1 cursor-pointer rounded-xl text-white shadow-none"
          >
            확인
          </AlertDialogAction>
        </AlertDialogFooter>
